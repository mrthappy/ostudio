      ...
      <div class="nav_menu">
	     ...
	     <div id="user_avatar">
           ...
           if(isset($_SESSION["logged"])):
			  ...
			  // make a query to get the users info
			  $userquery="select * from register where id='$id'";
			  $report=$database->query($userquery);
			  $result=$report->fetch_assoc();
        ...
        <?php 
		if($result):
		echo '<img src="../upload/'.$result["image"].'" class="image">';
		else:
		...
		<li><a href="" class="drop"><?php echo $result["nav_fifth"];?></a>
		</ul>
